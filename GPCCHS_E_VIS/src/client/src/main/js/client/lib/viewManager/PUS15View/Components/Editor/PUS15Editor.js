...
import { VM_VIEW_PUS15 } from 'viewManager/constants';
...
export default class PUS15Editor extends Component {
  static propTypes = {
    // own props
   ...
   */
  state = {
    PUS15EditorForm: WithForm(DefaultPusDataContainer),
  };
  ...
  render() {
    ...
    const { PUS15EditorForm } = this.state;
    return (
      <ErrorBoundary>
