...
export const WS_VIEW_UPDATE_TABLE_COLS = 'WS_VIEW_UPDATE_TABLE_COLS';
...
export const WS_VIEW_TABLE_UPDATE_DISPLAYED_PARAMS = 'WS_VIEW_TABLE_UPDATE_DISPLAYED_PARAMS';
