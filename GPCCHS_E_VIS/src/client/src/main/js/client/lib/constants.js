module.exports = {
  ...
  MESSAGETYPE_ALARM_QUERY: 22,
  MESSAGETYPE_ALARM_SUBSCRIPTION: 23,
  MESSAGETYPE_ALARM_ARCHIVE_DATA: 24,
  MESSAGETYPE_ALARM_PUBSUB_DATA: 25,
  ...
  // alarm
  GROUND_TYPE: 'GROUND',
  ONBOARD_TYPE: 'ONBOARD',
  ALARM_MODE_ALL: 'ALL',
  ALARM_MODE_NONNOMINAL: 'NON_NOMINAL',
  ALARM_MODE_TOACKNOWLEDGE: 'TO_ACKNOWLEDGE',
  ALARM_ACKSTATE_ACQUITED: 'ALARM_ACKSTATE_ACQUITED',
  ALARM_ACKSTATE_REQUIREACK: 'ALARM_ACKSTATE_REQUIREACK',
  ALARM_ACKSTATE_NOACK: 'ALARM_ACKSTATE_NOACK',
};
