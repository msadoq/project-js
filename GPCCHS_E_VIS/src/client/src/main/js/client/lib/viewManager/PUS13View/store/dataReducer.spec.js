import pus13DataReducer
  // { isExpectedValue, getELData, getHData,
  // selectExpectedData, bindToBoolKey }
  from 'viewManager/PUS13View/store/dataReducer';
import { INJECT_PUS_DATA } from '../../../store/types';

describe('viewManager/PUS13View/store/dataReducer', () => {
  it('should sort expected values and replace constants', () => {
    ...
    expect(pus13DataReducer(state, action)).toEqual({
      PUS13ViewData: {
        foo: 'foo',
        bar: 'bar',
