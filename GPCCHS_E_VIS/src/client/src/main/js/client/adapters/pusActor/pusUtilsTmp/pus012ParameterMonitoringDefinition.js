...
module.exports = {
  encode: data => ({
    ...
    validityParameterExpectedValue: (data.validityParameterExpectedValue !== null && typeof data.validityParameterExpectedValue !== 'undefined')
      ...
      : null,
    pus012MonitoringCheckPropertiesLow: _map(data.pus012MonitoringCheckPropertiesLow, monitoringCheckProp => pus012MonitoringCheckProperties.encode(monitoringCheckProp)),
    pus012MonitoringCheckPropertiesHigh: _map(data.pus012MonitoringCheckPropertiesHigh, monitoringCheckProp => pus012MonitoringCheckProperties.encode(monitoringCheckProp)),
    pus012MonitoringCheckPropertiesExpected: _map(data.pus012MonitoringCheckPropertiesExpected, monitoringCheckProp => pus012MonitoringCheckProperties.encode(monitoringCheckProp)),
  ...
  decode: data => ({
    ...
    validityParameterExpectedValue: (data.validityParameterExpectedValue !== null && typeof data.validityParameterExpectedValue !== 'undefined')
      ...
      : undefined,
    pus012MonitoringCheckPropertiesLow: _map(data.pus012MonitoringCheckPropertiesLow, monitoringCheckProp => pus012MonitoringCheckProperties.decode(monitoringCheckProp)),
    pus012MonitoringCheckPropertiesHigh: _map(data.pus012MonitoringCheckPropertiesHigh, monitoringCheckProp => pus012MonitoringCheckProperties.decode(monitoringCheckProp)),
    pus012MonitoringCheckPropertiesExpected: _map(data.pus012MonitoringCheckPropertiesExpected, monitoringCheckProp => pus012MonitoringCheckProperties.decode(monitoringCheckProp)),
    isMonitoringIntervalSet: (data.isMonitoringIntervalSet !== null && typeof data.isMonitoringIntervalSet !== 'undefined')
