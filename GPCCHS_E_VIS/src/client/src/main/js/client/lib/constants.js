...
module.exports = {
  ...
  PUS_CONSTANTS: {
    ENABLED_SERVICE_APIDS: {
      // Please choose between (case sensitive) TIMEPACKET / ATTITUDE / ORBIT / POWERMGT / SATELLITE / MISSION / FILEMGT / TELEMETRYMGT / OBCPENGINE1 / OBCPENGINE2 / TCFILEMGT / IDLEPACKET
