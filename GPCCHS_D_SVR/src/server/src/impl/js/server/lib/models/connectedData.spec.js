...
describe('models/connectedData', () => {
  ...
  describe('addRequestedInterval', () => {
    ...
    it('one', () => {
      ...
      connectedData[0].should.have.property('dataId', myDataId);
      connectedData[0].should.have.property('intervals');
      connectedData[0].intervals.should.be.an('array').that.have.lengthOf(0);
      connectedData[0].should.have.property('requested');
      connectedData[0].requested.should.be.an('object');
      connectedData[0].requested.should.have.property(myQueryId);
    ...
    it('multi', () => {
      ...
      connectedData[1].should.have.property('dataId', myDataId2);
      connectedData[1].should.have.property('intervals');
      connectedData[1].intervals.should.be.an('array').that.have.lengthOf(0);
      connectedData[1].should.have.property('requested');
      connectedData[1].requested.should.be.an('object');
      connectedData[1].requested.should.have.property(myQueryId2);
      connectedData[1].requested[myQueryId2].should.be.an('array').that.have.lengthOf(2);
  ...
  describe('setIntervalAsReceived', () => {
    ...
    it('one', () => {
      ...
      connectedData[0].should.be.an('object');
      connectedData[0].should.have.property('intervals');
      connectedData[0].intervals.should.be.an('array').that.have.lengthOf(1);
      connectedData[0].intervals[0].should.be.an('array').that.have.lengthOf(2);
      connectedData[0].intervals[0][0].should.equal(myInterval[0]);
      connectedData[0].intervals[0][1].should.equal(myInterval[1]);
      connectedData[0].should.have.property('requested');
      connectedData[0].requested.should.be.an('object').and.have.properties({});
    });
  });
