...
module.exports = {
  encode: data => ({
    serviceStatus: (data.serviceStatus !== null && typeof data.serviceStatus !== 'undefined')
      ...
      : null,
    pus142FunctionalMonitoring: _map(data.pus142FunctionalMonitoring, functionalMonitoring => pus142FunctionalMonitoring.encode(functionalMonitoring)),
  ...
  decode: data => ({
    serviceStatus: (data.serviceStatus !== null && typeof data.serviceStatus !== 'undefined')
      ...
      : undefined,
    pus142FunctionalMonitoring: _map(data.pus142FunctionalMonitoring, functionalMonitoring => pus142FunctionalMonitoring.decode(functionalMonitoring)),
    groundDate: (data.groundDate !== null && typeof data.groundDate !== 'undefined')
