...
describe('store:createReducerByViews', () => {
  ...
  describe('with all view types', () => {
    ...
    test('should create a new view', () => {
      ...
      expect(reducer(dummyState, createAction(types.WS_VIEW_OPEN))).toEqual({ ...dummyState, abcd: '__VIEW__' });
    ...
    test('add several views', () => {
      ...
      expect(reducer({}, createAction(types.WS_PAGE_OPEN))).toEqual({ d: '__VIEW__', e: '__VIEW__' });
      expect(reducer({}, createAction(types.WS_WORKSPACE_OPEN))).toEqual({ d: '__VIEW__', e: '__VIEW__' });
    });
