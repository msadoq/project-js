import pus19DataReducer from 'viewManager/PUS19View/store/dataReducer';
import { INJECT_PUS_DATA } from '../../../store/types';

describe('viewManager/PUS19View/store/dataReducer', () => {
  it('should replace constants', () => {
    ...
    expect(pus19DataReducer(state, action)).toEqual({
      PUS19ViewData: {
        foo: 'foo',
        bar: 'bar',
        tables: {
