...
// VERSION : 1.1.2 : DM : #5828 : 26/04/2017 : Window title edit : star appears on window,
//  workspace is isModified: true.
// VERSION : 1.1.2 : DM : #5828 : 28/04/2017 : Creation of display queries to pull data from server
//  and always add new data to queue
// VERSION : 1.1.2 : DM : #5828 : 28/04/2017 : Fix forecast when focused page changes and
//  visuWindow goes backwards
...
//  workspace mode
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 18/07/2017 : Open or close a window now set workspace
//  isModified to true
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 18/07/2017 : Open a blank workspace, set isModified to
//  true by default
