...
module.exports = {
  ...
  getAckProtobuf: override => ackBuilder.encode(ackAdapter.encode(ackStub(override))),
  getAckRequest: ackRequestStub,
  getAckRequestDeProtobuf: proto => ackRequestAdapter.decode(ackRequestBuilder.decode(proto)),
  getAckRequestProtobuf: override => ackRequestBuilder.encode(ackRequestAdapter.encode(ackRequestStub(override))),
  getAckSMS: ackSMSStub,
  getAction: actionStub,
  getActionDeProtobuf: proto => actionAdapter.decode(actionBuilder.decode(proto)),
  getActionProtobuf: override => actionBuilder.encode(actionAdapter.encode(actionStub(override))),
  ...
  getAttributeValueProtobuf: override => attributeValueBuilder.encode(attributeValueAdapter.encode(attributeValueStub(override))),
  getBinaryData: binaryDataStub,
  getBinaryDataDeProtobuf: proto => binaryDataAdapter.decode(binaryDataBuilder.decode(proto)),
  getBinaryDataProtobuf: override => binaryDataBuilder.encode(binaryDataAdapter.encode(binaryDataStub(override))),
  ...
  getBriefcaseContentProtobuf: override => briefcaseContentBuilder.encode(briefcaseContentAdapter.encode(briefcaseContentStub(override))),
  getBriefcaseDeProtobuf: proto => briefcaseAdapter.decode(briefcaseBuilder.decode(proto)),
  getBriefcaseProtobuf: override => briefcaseBuilder.encode(briefcaseAdapter.encode(briefcaseStub(override))),
  getCOP1Context: cOP1ContextStub,
  getCOP1ContextDeProtobuf: proto => cOP1ContextAdapter.decode(cOP1ContextBuilder.decode(proto)),
  getCOP1ContextProtobuf: override => cOP1ContextBuilder.encode(cOP1ContextAdapter.encode(cOP1ContextStub(override))),
  ...
  getCOP1DirectiveProtobuf: override => cOP1DirectiveBuilder.encode(cOP1DirectiveAdapter.encode(cOP1DirectiveStub(override))),
  ...
  getCOP1IfAutoStateProtobuf: override => cOP1IfAutoStateBuilder.encode(cOP1IfAutoStateAdapter.encode(cOP1IfAutoStateStub(override))),
  ...
  getCOP1InternalStateProtobuf: override => cOP1InternalStateBuilder.encode(cOP1InternalStateAdapter.encode(cOP1InternalStateStub(override))),
  ...
  getCOP1SentQueueProtobuf: override => cOP1SentQueueBuilder.encode(cOP1SentQueueAdapter.encode(cOP1SentQueueStub(override))),
  getCOP1Status: cOP1StatusStub,
  getCOP1StatusDeProtobuf: proto => cOP1StatusAdapter.decode(cOP1StatusBuilder.decode(proto)),
  getCOP1StatusProtobuf: override => cOP1StatusBuilder.encode(cOP1StatusAdapter.encode(cOP1StatusStub(override))),
  ...
  getCOP1WaitQueueProtobuf: override => cOP1WaitQueueBuilder.encode(cOP1WaitQueueAdapter.encode(cOP1WaitQueueStub(override))),
  ...
  getCUFullStatusProtobuf: override => cUFullStatusBuilder.encode(cUFullStatusAdapter.encode(cUFullStatusStub(override))),
  ...
  getCUIdentifierProtobuf: override => cUIdentifierBuilder.encode(cUIdentifierAdapter.encode(cUIdentifierStub(override))),
  getCUInfo: cUInfoStub,
  getCUInfoDeProtobuf: proto => cUInfoAdapter.decode(cUInfoBuilder.decode(proto)),
  getCUInfoProtobuf: override => cUInfoBuilder.encode(cUInfoAdapter.encode(cUInfoStub(override))),
  ...
  getCUOperationDefinitionProtobuf: override => cUOperationDefinitionBuilder.encode(cUOperationDefinitionAdapter.encode(cUOperationDefinitionStub(override))),
  getCUStatus: cUStatusStub,
  getCUStatusDeProtobuf: proto => cUStatusAdapter.decode(cUStatusBuilder.decode(proto)),
  getCUStatusProtobuf: override => cUStatusBuilder.encode(cUStatusAdapter.encode(cUStatusStub(override))),
  getClcwPacket: clcwPacketStub,
  getClcwPacketDeProtobuf: proto => clcwPacketAdapter.decode(clcwPacketBuilder.decode(proto)),
  getClcwPacketProtobuf: override => clcwPacketBuilder.encode(clcwPacketAdapter.encode(clcwPacketStub(override))),
  ...
  getClcwSegmentMaskProtobuf: override => clcwSegmentMaskBuilder.encode(clcwSegmentMaskAdapter.encode(clcwSegmentMaskStub(override))),
  ...
  getCollectionDocumentProtobuf: override => collectionDocumentBuilder.encode(collectionDocumentAdapter.encode(collectionDocumentStub(override))),
  getCollectionProtobuf: override => collectionBuilder.encode(collectionAdapter.encode(collectionStub(override))),
  ...
  getCollectionVirtualFolderProtobuf: override => collectionVirtualFolderBuilder.encode(collectionVirtualFolderAdapter.encode(collectionVirtualFolderStub(override))),
  ...
  getCompositeFilterProtobuf: override => compositeFilterBuilder.encode(compositeFilterAdapter.encode(compositeFilterStub(override))),
  ...
  getCompositeFilterSetProtobuf: override => compositeFilterSetBuilder.encode(compositeFilterSetAdapter.encode(compositeFilterSetStub(override))),
  ...
  getComputedEventProtobuf: override => computedEventBuilder.encode(computedEventAdapter.encode(computedEventStub(override))),
  ...
  getDecommutedPacketProtobuf: override => decommutedPacketBuilder.encode(decommutedPacketAdapter.encode(decommutedPacketStub(override))),
  ...
  getDecommutedParameterProtobuf: override => decommutedParameterBuilder.encode(decommutedParameterAdapter.encode(decommutedParameterStub(override))),
  ...
  getDecommutedValueProtobuf: override => decommutedValueBuilder.encode(decommutedValueAdapter.encode(decommutedValueStub(override))),
  getDocVersion: docVersionStub,
  getDocVersionDeProtobuf: proto => docVersionAdapter.decode(docVersionBuilder.decode(proto)),
  getDocVersionProtobuf: override => docVersionBuilder.encode(docVersionAdapter.encode(docVersionStub(override))),
  getDocument: documentStub,
  getDocumentDeProtobuf: proto => documentAdapter.decode(documentBuilder.decode(proto)),
  getDocumentProtobuf: override => documentBuilder.encode(documentAdapter.encode(documentStub(override))),
  ...
  getDocumentValueProtobuf: override => documentValueBuilder.encode(documentValueAdapter.encode(documentValueStub(override))),
  ...
  getEncodeArgumentRequestProtobuf: override => encodeArgumentRequestBuilder.encode(encodeArgumentRequestAdapter.encode(encodeArgumentRequestStub(override))),
  ...
  getEncodeInvocationProtobuf: override => encodeInvocationBuilder.encode(encodeInvocationAdapter.encode(encodeInvocationStub(override))),
  ...
  getEncodeLargeTCInvocationProtobuf: override => encodeLargeTCInvocationBuilder.encode(encodeLargeTCInvocationAdapter.encode(encodeLargeTCInvocationStub(override))),
  ...
  getEncodeResponseProtobuf: override => encodeResponseBuilder.encode(encodeResponseAdapter.encode(encodeResponseStub(override))),
  ...
  getEncodedValueProtobuf: override => encodedValueBuilder.encode(encodedValueAdapter.encode(encodedValueStub(override))),
  ...
  getEncodedValuesListProtobuf: override => encodedValuesListBuilder.encode(encodedValuesListAdapter.encode(encodedValuesListStub(override))),
  ...
  getEncodingActionProtobuf: override => encodingActionBuilder.encode(encodingActionAdapter.encode(encodingActionStub(override))),
  ...
  getEncryptResponseProtobuf: override => encryptResponseBuilder.encode(encryptResponseAdapter.encode(encryptResponseStub(override))),
  getEvent: eventStub,
  ...
  getEventDefinitionProtobuf: override => eventDefinitionBuilder.encode(eventDefinitionAdapter.encode(eventDefinitionStub(override))),
  getEventProtobuf: override => eventBuilder.encode(eventAdapter.encode(eventStub(override))),
  getExecution: executionStub,
  getExecutionDeProtobuf: proto => executionAdapter.decode(executionBuilder.decode(proto)),
  getExecutionProtobuf: override => executionBuilder.encode(executionAdapter.encode(executionStub(override))),
  ...
  getExpectedAckProtobuf: override => expectedAckBuilder.encode(expectedAckAdapter.encode(expectedAckStub(override))),
  ...
  getExternalEventProtobuf: override => externalEventBuilder.encode(externalEventAdapter.encode(externalEventStub(override))),
  getFlagVal: flagValStub,
  getFlagValDeProtobuf: proto => flagValAdapter.decode(flagValBuilder.decode(proto)),
  getFlagValProtobuf: override => flagValBuilder.encode(flagValAdapter.encode(flagValStub(override))),
  ...
  getFlowConfigurationProtobuf: override => flowConfigurationBuilder.encode(flowConfigurationAdapter.encode(flowConfigurationStub(override))),
  getFlowElmt: flowElmtStub,
  getFlowElmtDeProtobuf: proto => flowElmtAdapter.decode(flowElmtBuilder.decode(proto)),
  getFlowElmtProtobuf: override => flowElmtBuilder.encode(flowElmtAdapter.encode(flowElmtStub(override))),
  ...
  getFlowFullStatusProtobuf: override => flowFullStatusBuilder.encode(flowFullStatusAdapter.encode(flowFullStatusStub(override))),
  ...
  getFlowIdentifierProtobuf: override => flowIdentifierBuilder.encode(flowIdentifierAdapter.encode(flowIdentifierStub(override))),
  getFlowInfo: flowInfoStub,
  getFlowInfoDeProtobuf: proto => flowInfoAdapter.decode(flowInfoBuilder.decode(proto)),
  getFlowInfoProtobuf: override => flowInfoBuilder.encode(flowInfoAdapter.encode(flowInfoStub(override))),
  getFlowList: flowListStub,
  getFlowListDeProtobuf: proto => flowListAdapter.decode(flowListBuilder.decode(proto)),
  getFlowListProtobuf: override => flowListBuilder.encode(flowListAdapter.encode(flowListStub(override))),
  ...
  getFlowSmallStatusProtobuf: override => flowSmallStatusBuilder.encode(flowSmallStatusAdapter.encode(flowSmallStatusStub(override))),
  getFlowStatus: flowStatusStub,
  getFlowStatusDeProtobuf: proto => flowStatusAdapter.decode(flowStatusBuilder.decode(proto)),
  getFlowStatusProtobuf: override => flowStatusBuilder.encode(flowStatusAdapter.encode(flowStatusStub(override))),
  getFolder: folderStub,
  getFolderDeProtobuf: proto => folderAdapter.decode(folderBuilder.decode(proto)),
  getFolderProtobuf: override => folderBuilder.encode(folderAdapter.encode(folderStub(override))),
  getGPMCC1State: gPMCC1StateStub,
  getGPMCC1StateDeProtobuf: proto => gPMCC1StateAdapter.decode(gPMCC1StateBuilder.decode(proto)),
  getGPMCC1StateProtobuf: override => gPMCC1StateBuilder.encode(gPMCC1StateAdapter.encode(gPMCC1StateStub(override))),
  getGenericTC: genericTCStub,
  getGenericTCDeProtobuf: proto => genericTCAdapter.decode(genericTCBuilder.decode(proto)),
  getGenericTCProtobuf: override => genericTCBuilder.encode(genericTCAdapter.encode(genericTCStub(override))),
  ...
  getGroundMonitoringAlarmProtobuf: override => groundMonitoringAlarmBuilder.encode(groundMonitoringAlarmAdapter.encode(groundMonitoringAlarmStub(override))),
  ...
  getGroupDefinitionProtobuf: override => groupDefinitionBuilder.encode(groupDefinitionAdapter.encode(groupDefinitionStub(override))),
  ...
  getIfQueueElementProtobuf: override => ifQueueElementBuilder.encode(ifQueueElementAdapter.encode(ifQueueElementStub(override))),
  getIfQueueUnit: ifQueueUnitStub,
  getIfQueueUnitDeProtobuf: proto => ifQueueUnitAdapter.decode(ifQueueUnitBuilder.decode(proto)),
  getIfQueueUnitProtobuf: override => ifQueueUnitBuilder.encode(ifQueueUnitAdapter.encode(ifQueueUnitStub(override))),
  ...
  getIndexedValueProtobuf: override => indexedValueBuilder.encode(indexedValueAdapter.encode(indexedValueStub(override))),
  ...
  getInitFlowConfigurationProtobuf: override => initFlowConfigurationBuilder.encode(initFlowConfigurationAdapter.encode(initFlowConfigurationStub(override))),
  ...
  getInitStationConfigurationProtobuf: override => initStationConfigurationBuilder.encode(initStationConfigurationAdapter.encode(initStationConfigurationStub(override))),
  ...
  getIsisAggregationProtobuf: override => isisAggregationBuilder.encode(isisAggregationAdapter.encode(isisAggregationStub(override))),
  ...
  getIsisFilterSetProtobuf: override => isisFilterSetBuilder.encode(isisFilterSetAdapter.encode(isisFilterSetStub(override))),
  ...
  getLocationProtobuf: override => locationBuilder.encode(locationAdapter.encode(locationStub(override))),
  getLog: logStub,
  ...
  getLogbookEventProtobuf: override => logbookEventBuilder.encode(logbookEventAdapter.encode(logbookEventStub(override))),
  getMAP: mAPStub,
  getMAPData: mAPDataStub,
  getMAPDataDeProtobuf: proto => mAPDataAdapter.decode(mAPDataBuilder.decode(proto)),
  getMAPDataProtobuf: override => mAPDataBuilder.encode(mAPDataAdapter.encode(mAPDataStub(override))),
  getMAPDeProtobuf: proto => mAPAdapter.decode(mAPBuilder.decode(proto)),
  getMAPProtobuf: override => mAPBuilder.encode(mAPAdapter.encode(mAPStub(override))),
  getMemoryImage: memoryImageStub,
  getMemoryImageDeProtobuf: proto => memoryImageAdapter.decode(memoryImageBuilder.decode(proto)),
  getMemoryImageProtobuf: override => memoryImageBuilder.encode(memoryImageAdapter.encode(memoryImageStub(override))),
  getNamedValue: namedValueStub,
  getNamedValueDeProtobuf: proto => namedValueAdapter.decode(namedValueBuilder.decode(proto)),
  getNamedValueProtobuf: override => namedValueBuilder.encode(namedValueAdapter.encode(namedValueStub(override))),
  ...
  getNominalStationProtobuf: override => nominalStationBuilder.encode(nominalStationAdapter.encode(nominalStationStub(override))),
  ...
  getOpAlertClosingDataProtobuf: override => opAlertClosingDataBuilder.encode(opAlertClosingDataAdapter.encode(opAlertClosingDataStub(override))),
  ...
  getOpAlertConfigurationProtobuf: override => opAlertConfigurationBuilder.encode(opAlertConfigurationAdapter.encode(opAlertConfigurationStub(override))),
  getOpAlertDeProtobuf: proto => opAlertAdapter.decode(opAlertBuilder.decode(proto)),
  getOpAlertProtobuf: override => opAlertBuilder.encode(opAlertAdapter.encode(opAlertStub(override))),
  ...
  getOperationDefinitionProtobuf: override => operationDefinitionBuilder.encode(operationDefinitionAdapter.encode(operationDefinitionStub(override))),
  ...
  getOperationParameterProtobuf: override => operationParameterBuilder.encode(operationParameterAdapter.encode(operationParameterStub(override))),
  getPacket: packetStub,
  getPacketDeProtobuf: proto => packetAdapter.decode(packetBuilder.decode(proto)),
  getPacketProtobuf: override => packetBuilder.encode(packetAdapter.encode(packetStub(override))),
  getParameter: parameterStub,
  getParameterDeProtobuf: proto => parameterAdapter.decode(parameterBuilder.decode(proto)),
  getParameterProtobuf: override => parameterBuilder.encode(parameterAdapter.encode(parameterStub(override))),
  ...
  getParameterValueProtobuf: override => parameterValueBuilder.encode(parameterValueAdapter.encode(parameterValueStub(override))),
  ...
  getProccessedTCProtobuf: override => proccessedTCBuilder.encode(proccessedTCAdapter.encode(proccessedTCStub(override))),
  ...
  getProcessFullStateProtobuf: override => processFullStateBuilder.encode(processFullStateAdapter.encode(processFullStateStub(override))),
  ...
  getProcessIdentifierProtobuf: override => processIdentifierBuilder.encode(processIdentifierAdapter.encode(processIdentifierStub(override))),
  getProcessInfo: processInfoStub,
  getProcessInfoDeProtobuf: proto => processInfoAdapter.decode(processInfoBuilder.decode(proto)),
  getProcessInfoProtobuf: override => processInfoBuilder.encode(processInfoAdapter.encode(processInfoStub(override))),
  ...
  getProfileRightProtobuf: override => profileRightBuilder.encode(profileRightAdapter.encode(profileRightStub(override))),
  ...
  getPus003DiagnosticPacketProtobuf: override => pus003DiagnosticPacketBuilder.encode(pus003DiagnosticPacketAdapter.encode(pus003DiagnosticPacketStub(override))),
  ...
  getPus003HkPacketProtobuf: override => pus003HkPacketBuilder.encode(pus003HkPacketAdapter.encode(pus003HkPacketStub(override))),
  getPus003Model: pus003ModelStub,
  getPus003ModelDeProtobuf: proto => pus003ModelAdapter.decode(pus003ModelBuilder.decode(proto)),
  getPus003ModelProtobuf: override => pus003ModelBuilder.encode(pus003ModelAdapter.encode(pus003ModelStub(override))),
  ...
  getPus003PacketProtobuf: override => pus003PacketBuilder.encode(pus003PacketAdapter.encode(pus003PacketStub(override))),
  getPus005Model: pus005ModelStub,
  getPus005ModelDeProtobuf: proto => pus005ModelAdapter.decode(pus005ModelBuilder.decode(proto)),
  getPus005ModelProtobuf: override => pus005ModelBuilder.encode(pus005ModelAdapter.encode(pus005ModelStub(override))),
  ...
  getPus005OnBoardEventProtobuf: override => pus005OnBoardEventBuilder.encode(pus005OnBoardEventAdapter.encode(pus005OnBoardEventStub(override))),
  getPus011Apid: pus011ApidStub,
  getPus011ApidDeProtobuf: proto => pus011ApidAdapter.decode(pus011ApidBuilder.decode(proto)),
  getPus011ApidProtobuf: override => pus011ApidBuilder.encode(pus011ApidAdapter.encode(pus011ApidStub(override))),
  ...
  getPus011CommandParameterProtobuf: override => pus011CommandParameterBuilder.encode(pus011CommandParameterAdapter.encode(pus011CommandParameterStub(override))),
  getPus011CommandProtobuf: override => pus011CommandBuilder.encode(pus011CommandAdapter.encode(pus011CommandStub(override))),
  ...
  getPus011EncapsulatingTcProtobuf: override => pus011EncapsulatingTcBuilder.encode(pus011EncapsulatingTcAdapter.encode(pus011EncapsulatingTcStub(override))),
  getPus011Model: pus011ModelStub,
  getPus011ModelDeProtobuf: proto => pus011ModelAdapter.decode(pus011ModelBuilder.decode(proto)),
  getPus011ModelProtobuf: override => pus011ModelBuilder.encode(pus011ModelAdapter.encode(pus011ModelStub(override))),
  ...
  getPus011SubScheduleProtobuf: override => pus011SubScheduleBuilder.encode(pus011SubScheduleAdapter.encode(pus011SubScheduleStub(override))),
  ...
  getPus011SyncPointProtobuf: override => pus011SyncPointBuilder.encode(pus011SyncPointAdapter.encode(pus011SyncPointStub(override))),
  ...
  getPus011TimeShiftProtobuf: override => pus011TimeShiftBuilder.encode(pus011TimeShiftAdapter.encode(pus011TimeShiftStub(override))),
  getPus012Model: pus012ModelStub,
  getPus012ModelDeProtobuf: proto => pus012ModelAdapter.decode(pus012ModelBuilder.decode(proto)),
  getPus012ModelProtobuf: override => pus012ModelBuilder.encode(pus012ModelAdapter.encode(pus012ModelStub(override))),
  ...
  getPus012MonitoringCheckPropertiesProtobuf: override => pus012MonitoringCheckPropertiesBuilder.encode(pus012MonitoringCheckPropertiesAdapter.encode(pus012MonitoringCheckPropertiesStub(override))),
  ...
  getPus012ParameterMonitoringDefinitionProtobuf: override => pus012ParameterMonitoringDefinitionBuilder.encode(pus012ParameterMonitoringDefinitionAdapter.encode(pus012ParameterMonitoringDefinitionStub(override))),
  ...
  getPus013DownlinkLdtProtobuf: override => pus013DownlinkLdtBuilder.encode(pus013DownlinkLdtAdapter.encode(pus013DownlinkLdtStub(override))),
  ...
  getPus013LdtPartProtobuf: override => pus013LdtPartBuilder.encode(pus013LdtPartAdapter.encode(pus013LdtPartStub(override))),
  getPus013LdtProtobuf: override => pus013LdtBuilder.encode(pus013LdtAdapter.encode(pus013LdtStub(override))),
  getPus013Model: pus013ModelStub,
  getPus013ModelDeProtobuf: proto => pus013ModelAdapter.decode(pus013ModelBuilder.decode(proto)),
  getPus013ModelProtobuf: override => pus013ModelBuilder.encode(pus013ModelAdapter.encode(pus013ModelStub(override))),
  ...
  getPus013UplinkLdtProtobuf: override => pus013UplinkLdtBuilder.encode(pus013UplinkLdtAdapter.encode(pus013UplinkLdtStub(override))),
  ...
  getPus014EventReportPacketProtobuf: override => pus014EventReportPacketBuilder.encode(pus014EventReportPacketAdapter.encode(pus014EventReportPacketStub(override))),
  ...
  getPus014ForwardedPacketProtobuf: override => pus014ForwardedPacketBuilder.encode(pus014ForwardedPacketAdapter.encode(pus014ForwardedPacketStub(override))),
  ...
  getPus014HkOrDiagPacketProtobuf: override => pus014HkOrDiagPacketBuilder.encode(pus014HkOrDiagPacketAdapter.encode(pus014HkOrDiagPacketStub(override))),
  getPus014Model: pus014ModelStub,
  getPus014ModelDeProtobuf: proto => pus014ModelAdapter.decode(pus014ModelBuilder.decode(proto)),
  getPus014ModelProtobuf: override => pus014ModelBuilder.encode(pus014ModelAdapter.encode(pus014ModelStub(override))),
  ...
  getPus014TmPacketProtobuf: override => pus014TmPacketBuilder.encode(pus014TmPacketAdapter.encode(pus014TmPacketStub(override))),
  getPus015Model: pus015ModelStub,
  getPus015ModelDeProtobuf: proto => pus015ModelAdapter.decode(pus015ModelBuilder.decode(proto)),
  getPus015ModelProtobuf: override => pus015ModelBuilder.encode(pus015ModelAdapter.encode(pus015ModelStub(override))),
  ...
  getPus015PacketProtobuf: override => pus015PacketBuilder.encode(pus015PacketAdapter.encode(pus015PacketStub(override))),
  ...
  getPus015PacketStoreProtobuf: override => pus015PacketStoreBuilder.encode(pus015PacketStoreAdapter.encode(pus015PacketStoreStub(override))),
  ...
  getPus018ConfiguredObcpProtobuf: override => pus018ConfiguredObcpBuilder.encode(pus018ConfiguredObcpAdapter.encode(pus018ConfiguredObcpStub(override))),
  getPus018Model: pus018ModelStub,
  getPus018ModelDeProtobuf: proto => pus018ModelAdapter.decode(pus018ModelBuilder.decode(proto)),
  getPus018ModelProtobuf: override => pus018ModelBuilder.encode(pus018ModelAdapter.encode(pus018ModelStub(override))),
  getPus018Obcp: pus018ObcpStub,
  getPus018ObcpDeProtobuf: proto => pus018ObcpAdapter.decode(pus018ObcpBuilder.decode(proto)),
  getPus018ObcpProtobuf: override => pus018ObcpBuilder.encode(pus018ObcpAdapter.encode(pus018ObcpStub(override))),
  ...
  getPus019EventActionProtobuf: override => pus019EventActionBuilder.encode(pus019EventActionAdapter.encode(pus019EventActionStub(override))),
  getPus019Model: pus019ModelStub,
  getPus019ModelDeProtobuf: proto => pus019ModelAdapter.decode(pus019ModelBuilder.decode(proto)),
  getPus019ModelProtobuf: override => pus019ModelBuilder.encode(pus019ModelAdapter.encode(pus019ModelStub(override))),
  getPus140Model: pus140ModelStub,
  getPus140ModelDeProtobuf: proto => pus140ModelAdapter.decode(pus140ModelBuilder.decode(proto)),
  getPus140ModelProtobuf: override => pus140ModelBuilder.encode(pus140ModelAdapter.encode(pus140ModelStub(override))),
  ...
  getPus140ParameterProtobuf: override => pus140ParameterBuilder.encode(pus140ParameterAdapter.encode(pus140ParameterStub(override))),
  ...
  getPus142FunctionalMonitoringProtobuf: override => pus142FunctionalMonitoringBuilder.encode(pus142FunctionalMonitoringAdapter.encode(pus142FunctionalMonitoringStub(override))),
  getPus142Model: pus142ModelStub,
  getPus142ModelDeProtobuf: proto => pus142ModelAdapter.decode(pus142ModelBuilder.decode(proto)),
  getPus142ModelProtobuf: override => pus142ModelBuilder.encode(pus142ModelAdapter.encode(pus142ModelStub(override))),
  ...
  getPus142ParameterMonitoringDefinitionProtobuf: override => pus142ParameterMonitoringDefinitionBuilder.encode(pus142ParameterMonitoringDefinitionAdapter.encode(pus142ParameterMonitoringDefinitionStub(override))),
  getPus144Model: pus144ModelStub,
  getPus144ModelDeProtobuf: proto => pus144ModelAdapter.decode(pus144ModelBuilder.decode(proto)),
  getPus144ModelProtobuf: override => pus144ModelBuilder.encode(pus144ModelAdapter.encode(pus144ModelStub(override))),
  ...
  getPus144OnboardFilesProtobuf: override => pus144OnboardFilesBuilder.encode(pus144OnboardFilesAdapter.encode(pus144OnboardFilesStub(override))),
  ...
  getPusElementListProtobuf: override => pusElementListBuilder.encode(pusElementListAdapter.encode(pusElementListStub(override))),
  getPusElementProtobuf: override => pusElementBuilder.encode(pusElementAdapter.encode(pusElementStub(override))),
  getPusHeader: pusHeaderStub,
  getPusHeaderDeProtobuf: proto => pusHeaderAdapter.decode(pusHeaderBuilder.decode(proto)),
  getPusHeaderProtobuf: override => pusHeaderBuilder.encode(pusHeaderAdapter.encode(pusHeaderStub(override))),
  ...
  getPusParameterProtobuf: override => pusParameterBuilder.encode(pusParameterAdapter.encode(pusParameterStub(override))),
  getPusValue: pusValueStub,
  getPusValueDeProtobuf: proto => pusValueAdapter.decode(pusValueBuilder.decode(proto)),
  getPusValueProtobuf: override => pusValueBuilder.encode(pusValueAdapter.encode(pusValueStub(override))),
  getRawData: rawDataStub,
  getRawDataDeProtobuf: proto => rawDataAdapter.decode(rawDataBuilder.decode(proto)),
  getRawDataProtobuf: override => rawDataBuilder.encode(rawDataAdapter.encode(rawDataStub(override))),
  ...
  getReportingParameterProtobuf: override => reportingParameterBuilder.encode(reportingParameterAdapter.encode(reportingParameterStub(override))),
  getRmPacket: rmPacketStub,
  getRmPacketDeProtobuf: proto => rmPacketAdapter.decode(rmPacketBuilder.decode(proto)),
  getRmPacketProtobuf: override => rmPacketBuilder.encode(rmPacketAdapter.encode(rmPacketStub(override))),
  ...
  getSentQueueElementProtobuf: override => sentQueueElementBuilder.encode(sentQueueElementAdapter.encode(sentQueueElementStub(override))),
  ...
  getSpecificAttributeDefinitionProtobuf: override => specificAttributeDefinitionBuilder.encode(specificAttributeDefinitionAdapter.encode(specificAttributeDefinitionStub(override))),
  getStationElmt: stationElmtStub,
  getStationElmtDeProtobuf: proto => stationElmtAdapter.decode(stationElmtBuilder.decode(proto)),
  getStationElmtProtobuf: override => stationElmtBuilder.encode(stationElmtAdapter.encode(stationElmtStub(override))),
  ...
  getStationFullStatusProtobuf: override => stationFullStatusBuilder.encode(stationFullStatusAdapter.encode(stationFullStatusStub(override))),
  ...
  getStationIdentifierProtobuf: override => stationIdentifierBuilder.encode(stationIdentifierAdapter.encode(stationIdentifierStub(override))),
  getStationList: stationListStub,
  getStationListDeProtobuf: proto => stationListAdapter.decode(stationListBuilder.decode(proto)),
  getStationListProtobuf: override => stationListBuilder.encode(stationListAdapter.encode(stationListStub(override))),
  ...
  getStationStatusProtobuf: override => stationStatusBuilder.encode(stationStatusAdapter.encode(stationStatusStub(override))),
  ...
  getStatisticFunctionDetailsProtobuf: override => statisticFunctionDetailsBuilder.encode(statisticFunctionDetailsAdapter.encode(statisticFunctionDetailsStub(override))),
  ...
  getStatisticFunctionDetailsStructProtobuf: override => statisticFunctionDetailsStructBuilder.encode(statisticFunctionDetailsStructAdapter.encode(statisticFunctionDetailsStructStub(override))),
  ...
  getStatisticFunctionValueProtobuf: override => statisticFunctionValueBuilder.encode(statisticFunctionValueAdapter.encode(statisticFunctionValueStub(override))),
  ...
  getStatisticParameterReportProtobuf: override => statisticParameterReportBuilder.encode(statisticParameterReportAdapter.encode(statisticParameterReportStub(override))),
  ...
  getStatisticValueProtobuf: override => statisticValueBuilder.encode(statisticValueAdapter.encode(statisticValueStub(override))),
  ...
  getStatisticValueStructProtobuf: override => statisticValueStructBuilder.encode(statisticValueStructAdapter.encode(statisticValueStructStub(override))),
  ...
  getSuccessiveAckProtobuf: override => successiveAckBuilder.encode(successiveAckAdapter.encode(successiveAckStub(override))),
  getTC11: tC11Stub,
  getTC11DeProtobuf: proto => tC11Adapter.decode(tC11Builder.decode(proto)),
  getTC11Protobuf: override => tC11Builder.encode(tC11Adapter.encode(tC11Stub(override))),
  getTC13: tC13Stub,
  getTC13DeProtobuf: proto => tC13Adapter.decode(tC13Builder.decode(proto)),
  getTC13Protobuf: override => tC13Builder.encode(tC13Adapter.encode(tC13Stub(override))),
  getTCDetails: tCDetailsStub,
  getTCDetailsDeProtobuf: proto => tCDetailsAdapter.decode(tCDetailsBuilder.decode(proto)),
  getTCDetailsProtobuf: override => tCDetailsBuilder.encode(tCDetailsAdapter.encode(tCDetailsStub(override))),
  getTCFile: tCFileStub,
  getTCFileDeProtobuf: proto => tCFileAdapter.decode(tCFileBuilder.decode(proto)),
  getTCFileProtobuf: override => tCFileBuilder.encode(tCFileAdapter.encode(tCFileStub(override))),
  getTCHistory: tCHistoryStub,
  getTCHistoryDeProtobuf: proto => tCHistoryAdapter.decode(tCHistoryBuilder.decode(proto)),
  getTCHistoryProtobuf: override => tCHistoryBuilder.encode(tCHistoryAdapter.encode(tCHistoryStub(override))),
  getTCImmediate: tCImmediateStub,
  getTCImmediateDeProtobuf: proto => tCImmediateAdapter.decode(tCImmediateBuilder.decode(proto)),
  getTCImmediateProtobuf: override => tCImmediateBuilder.encode(tCImmediateAdapter.encode(tCImmediateStub(override))),
  getTCLong: tCLongStub,
  getTCLongDeProtobuf: proto => tCLongAdapter.decode(tCLongBuilder.decode(proto)),
  getTCLongProtobuf: override => tCLongBuilder.encode(tCLongAdapter.encode(tCLongStub(override))),
  ...
  getTCPhysicalParameterProtobuf: override => tCPhysicalParameterBuilder.encode(tCPhysicalParameterAdapter.encode(tCPhysicalParameterStub(override))),
  ...
  getTimeTaggedTCProtobuf: override => timeTaggedTCBuilder.encode(timeTaggedTCAdapter.encode(timeTaggedTCStub(override))),
  ...
  getTimeTaggedTelecommandProtobuf: override => timeTaggedTelecommandBuilder.encode(timeTaggedTelecommandAdapter.encode(timeTaggedTelecommandStub(override))),
  getTmPacket: tmPacketStub,
  getTmPacketDeProtobuf: proto => tmPacketAdapter.decode(tmPacketBuilder.decode(proto)),
  getTmPacketProtobuf: override => tmPacketBuilder.encode(tmPacketAdapter.encode(tmPacketStub(override))),
  getTransition: transitionStub,
  getTransitionDeProtobuf: proto => transitionAdapter.decode(transitionBuilder.decode(proto)),
  getTransitionProtobuf: override => transitionBuilder.encode(transitionAdapter.encode(transitionStub(override))),
  ...
  getTransportedDocumentsProtobuf: override => transportedDocumentsBuilder.encode(transportedDocumentsAdapter.encode(transportedDocumentsStub(override))),
  ...
  getTransportedGroundAlarmProtobuf: override => transportedGroundAlarmBuilder.encode(transportedGroundAlarmAdapter.encode(transportedGroundAlarmStub(override))),
  ...
  getUCPParameterProtobuf: override => uCPParameterBuilder.encode(uCPParameterAdapter.encode(uCPParameterStub(override))),
  getUCPReport: uCPReportStub,
  getUCPReportDeProtobuf: proto => uCPReportAdapter.decode(uCPReportBuilder.decode(proto)),
  getUCPReportProtobuf: override => uCPReportBuilder.encode(uCPReportAdapter.encode(uCPReportStub(override))),
  getUser: userStub,
  ...
  getUserEventProtobuf: override => userEventBuilder.encode(userEventAdapter.encode(userEventStub(override))),
  getUserRight: userRightStub,
  getUserRightDeProtobuf: proto => userRightAdapter.decode(userRightBuilder.decode(proto)),
  getUserRightProtobuf: override => userRightBuilder.encode(userRightAdapter.encode(userRightStub(override))),
};
