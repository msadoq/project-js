  ...
  test('decode', () => {
    ...
    for (let i = 0; i < stub.pus012ParameterMonitoringDefinition.length; i += 1) {
      expect(decoded.pus012ParameterMonitoringDefinition[i]).toMatchObject({
        ...
        checkType: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].checkType },
        monitoringStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].monitoringStatus },
        pus012MonitoringCheckPropertiesLow: (typeof stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow === 'undefined')
          ? null
          : {
            ridStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.ridStatus },
            actionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.actionStatus },
            ...
            lastUpdateModeRid: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.lastUpdateModeRid },
            ...
            lastUpdateModeActionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.lastUpdateModeActionStatus },
            ...
            lastUpdateModeRidStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.lastUpdateModeRidStatus },
            ...
            lastUpdateModeMask: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.lastUpdateModeMask },
            ...
            lastUpdateModeValue: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.lastUpdateModeValue },
        ...
        pus012MonitoringCheckPropertiesHigh: (typeof stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh === 'undefined')
          ? null
          : {
            ridStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.ridStatus },
            actionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.actionStatus },
            ...
            lastUpdateModeRid: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.lastUpdateModeRid },
            ...
            lastUpdateModeActionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.lastUpdateModeActionStatus },
            ...
            lastUpdateModeRidStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.lastUpdateModeRidStatus },
            ...
            lastUpdateModeMask: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.lastUpdateModeMask },
            ...
            lastUpdateModeValue: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.lastUpdateModeValue },
        ...
        pus012MonitoringCheckPropertiesExpected: (typeof stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected === 'undefined')
          ? null
          : {
            ridStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.ridStatus },
            actionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.actionStatus },
            ...
            lastUpdateModeRid: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.lastUpdateModeRid },
            ...
            lastUpdateModeActionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.lastUpdateModeActionStatus },
            ...
            lastUpdateModeRidStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.lastUpdateModeRidStatus },
            ...
            lastUpdateModeMask: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.lastUpdateModeMask },
            ...
            lastUpdateModeValue: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.lastUpdateModeValue },
        ...
        pusElement: {
          lastUpdateMode: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].pusElement.lastUpdateMode },
        ...
        lastUpdateModeMonId: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeMonId },
        lastUpdateTimeMonId: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeMonId },
        lastUpdateModeParamId: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeParamId },
        lastUpdateTimeParamId: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeParamId },
        lastUpdateModeValParamId: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeValParamId },
        lastUpdateTimeValParamId: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeValParamId },
        lastUpdateModeParamCurrentValue: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeParamCurrentValue },
        ...
        lastUpdateModeValParamExpectValue: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeValParamExpectValue },
        ...
        lastUpdateModeValParamMask: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeValParamMask },
        lastUpdateTimeValParamMask: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeValParamMask },
        lastUpdateModeMonInterval: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeMonInterval },
        lastUpdateTimeMonInterval: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeMonInterval },
        lastUpdateModeRepetition: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeRepetition },
        lastUpdateTimeRepetition: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeRepetition },
        lastUpdateModeCheckType: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeCheckType },
        lastUpdateTimeCheckTime: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeCheckTime },
        lastUpdateModeMonStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeMonStatus },
        lastUpdateTimeMonStatus: { type: 'time', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateTimeMonStatus },
        lastUpdateModeProtectionStatus: { type: 'uoctet', value: stub.pus012ParameterMonitoringDefinition[i].lastUpdateModeProtectionStatus },
