...
export default class PUS140Tab extends React.Component {
  static propTypes = {
    // own props
    viewId: PropTypes.string.isRequired,
    panels: PropTypes.shape({}).isRequired,
    // from PUS140TabContainer mapDispatchToProps
      ...
      <ErrorBoundary>
        ...
        >
          ...
          <Panel
            ...
            key="pus140-onboard-storages-panel"
          >
            {
              panels['pus140-onboard-storages-panel'] &&
          ...
          <Panel
            ...
            key="pus140-storage-def-panel"
          >
            {
              panels['pus140-storage-def-panel'] &&
              <TableColumnsEditorContainer
                viewId={viewId}
                tableId={'storageDef'}
              />
