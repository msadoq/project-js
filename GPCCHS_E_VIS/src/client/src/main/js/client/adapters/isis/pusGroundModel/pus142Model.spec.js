  ...
  test('decode', () => {
    ...
    for (let i = 0; i < stub.pus142FunctionalMonitoring.length; i += 1) {
      expect(decoded.pus142FunctionalMonitoring[i]).toMatchObject({
        ...
        status: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].status },
        ...
        pusElement: {
          lastUpdateMode: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].pusElement.lastUpdateMode },
        ...
        lastUpdateModeFMonId: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeFMonId },
        lastUpdateTimeFMonId: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeFMonId },
        lastUpdateModeProtectionStatus: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeProtectionStatus },
        lastUpdateTimeProtectionStatus: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeProtectionStatus },
        lastUpdateModeCheckingStatus: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeCheckingStatus },
        lastUpdateTimeCheckingStatus: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeCheckingStatus },
        lastUpdateModeStatus: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeStatus },
        lastUpdateTimeStatus: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeStatus },
        lastUpdateModeRid: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeRid },
        lastUpdateTimeRid: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeRid },
        lastUpdateModeValidParamId: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeValidParamId },
        lastUpdateTimeValidParamId: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeValidParamId },
        lastUpdateModeValidParamMask: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeValidParamMask },
        lastUpdateTimeValidParamMask: { type: 'time', value: stub.pus142FunctionalMonitoring[i].lastUpdateTimeValidParamMask },
        lastUpdateModeValidParamExpectedValue: { type: 'uoctet', value: stub.pus142FunctionalMonitoring[i].lastUpdateModeValidParamExpectedValue },
