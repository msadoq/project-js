    ...
    for (let i = 0; i < stub.pUS013UplinkLdt.length; i += 1) {
      expect(decoded.pUS013UplinkLdt[i]).toMatchObject({
        ...
        pus013Ldt: {
          ...
          lastUpdateModeLduId: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeLduId },
          lastUpdateTimeLduId: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeLduId },
          lastUpdateModeSize: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeSize },
          lastUpdateTimeSize: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeSize },
          lastUpdateModeStartTime: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeStartTime },
          lastUpdateTimeStartTime: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeStartTime },
          lastUpdateModeEndTime: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeEndTime },
          lastUpdateTimeEndTime: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeEndTime },
          lastUpdateModeStatus: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeStatus },
          lastUpdateTimeStatus: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeStatus },
          lastUpdateModeRemainSize: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeRemainSize },
          lastUpdateTimeRemainSize: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeRemainSize },
          lastUpdateModePercent: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModePercent },
          lastUpdateTimePercent: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimePercent },
          lastUpdateModeFailureCode: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeFailureCode },
          lastUpdateTimeFailureCode: { type: 'time', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateTimeFailureCode },
          lastUpdateModeFileChecksum: { type: 'uinteger', value: stub.pUS013UplinkLdt[i].pus013Ldt.lastUpdateModeFileChecksum },
    ...
    for (let i = 0; i < stub.pUS013DownlinkLdt.length; i += 1) {
      expect(decoded.pUS013DownlinkLdt[i]).toMatchObject({
        ...
        pus013Ldt: {
          ...
          lastUpdateModeLduId: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeLduId },
          lastUpdateTimeLduId: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeLduId },
          lastUpdateModeSize: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeSize },
          lastUpdateTimeSize: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeSize },
          lastUpdateModeStartTime: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeStartTime },
          lastUpdateTimeStartTime: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeStartTime },
          lastUpdateModeEndTime: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeEndTime },
          lastUpdateTimeEndTime: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeEndTime },
          lastUpdateModeStatus: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeStatus },
          lastUpdateTimeStatus: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeStatus },
          lastUpdateModeRemainSize: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeRemainSize },
          lastUpdateTimeRemainSize: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeRemainSize },
          lastUpdateModePercent: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModePercent },
          lastUpdateTimePercent: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimePercent },
          lastUpdateModeFailureCode: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeFailureCode },
          lastUpdateTimeFailureCode: { type: 'time', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateTimeFailureCode },
          lastUpdateModeFileChecksum: { type: 'uinteger', value: stub.pUS013DownlinkLdt[i].pus013Ldt.lastUpdateModeFileChecksum },
