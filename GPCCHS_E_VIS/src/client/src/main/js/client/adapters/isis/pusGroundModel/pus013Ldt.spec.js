...
describe('protobuf/isis/pusGroundModel/Pus013Ldt', () => {
  ...
  test('decode', () => {
    ...
    expect(decoded).toMatchObject({
      ...
      lastUpdateModeLduId: { type: 'uoctet', value: stub.lastUpdateModeLduId },
      lastUpdateTimeLduId: { type: 'time', value: stub.lastUpdateTimeLduId },
      lastUpdateModeSize: { type: 'uoctet', value: stub.lastUpdateModeSize },
      lastUpdateTimeSize: { type: 'time', value: stub.lastUpdateTimeSize },
      lastUpdateModeStartTime: { type: 'uoctet', value: stub.lastUpdateModeStartTime },
      lastUpdateTimeStartTime: { type: 'time', value: stub.lastUpdateTimeStartTime },
      lastUpdateModeEndTime: { type: 'uoctet', value: stub.lastUpdateModeEndTime },
      ...
      lastUpdateModeRemainSize: { type: 'uoctet', value: stub.lastUpdateModeRemainSize },
      lastUpdateTimeRemainSize: { type: 'time', value: stub.lastUpdateTimeRemainSize },
      lastUpdateModePercent: { type: 'uoctet', value: stub.lastUpdateModePercent },
      lastUpdateTimePercent: { type: 'time', value: stub.lastUpdateTimePercent },
      lastUpdateModeFailureCode: { type: 'uoctet', value: stub.lastUpdateModeFailureCode },
      lastUpdateTimeFailureCode: { type: 'time', value: stub.lastUpdateTimeFailureCode },
      lastUpdateModeFileChecksum: { type: 'uoctet', value: stub.lastUpdateModeFileChecksum },
    ...
    for (let i = 0; i < stub.pUS013LdtPart.length; i += 1) {
      expect(decoded.pUS013LdtPart[i]).toMatchObject({
        status: { type: 'uoctet', value: stub.pUS013LdtPart[i].status },
        ...
        pusElement: {
          lastUpdateMode: { type: 'uoctet', value: stub.pUS013LdtPart[i].pusElement.lastUpdateMode },
