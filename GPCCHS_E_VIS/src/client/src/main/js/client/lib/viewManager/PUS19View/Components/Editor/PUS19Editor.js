...
import { VM_VIEW_PUS19 } from 'viewManager/constants';
...
export default class PUS19Editor extends Component {
  static propTypes = {
    // own props
   ...
   */
  state = {
    PUS19EditorForm: WithForm(DefaultPusDataContainer),
  };
  ...
  render() {
    ...
    const { PUS19EditorForm } = this.state;
    return (
      <ErrorBoundary>
