// ====================================================================
// HISTORY
// VERSION : 1.1.2 : FA : #7299 : 19/07/2017 : Add script to install npm dependencies for the
//  adapters
// VERSION : 1.1.2 : FA : #7299 : 20/07/2017 : Fix postinstall script adapters : hardcoded paths
//  (relatives)
...
const adapters = ['isis', 'dc', 'pusActor'];
