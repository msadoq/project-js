...
import { VM_VIEW_PUS144 } from 'viewManager/constants';
...
export default class PUS144Editor extends Component {
  static propTypes = {
    // own props
    ...
    configuration: PropTypes.shape({
      ...
      tables: PropTypes.shape({
        onBoardPartitions: PropTypes.shape({
   ...
   */
  state = {
    PUS144EditorForm: WithForm(DefaultPusDataContainer),
  };
  ...
  render() {
    ...
    const { PUS144EditorForm } = this.state;
    return (
      <ErrorBoundary>
