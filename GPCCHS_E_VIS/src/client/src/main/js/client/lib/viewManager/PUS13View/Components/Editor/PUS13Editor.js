...
import { VM_VIEW_PUS13 } from 'viewManager/constants';
...
export default class PUS13Editor extends Component {
  static propTypes = {
    // own props
    ...
    configuration: PropTypes.shape({
      ...
      tables: PropTypes.shape({
        parameterMonitoringDefinitions: PropTypes.shape({
   ...
   */
  state = {
    PUS13EditorForm: WithForm(DefaultPusDataContainer),
  };
  ...
  render() {
    ...
    const { PUS13EditorForm } = this.state;
    return (
      <ErrorBoundary>
