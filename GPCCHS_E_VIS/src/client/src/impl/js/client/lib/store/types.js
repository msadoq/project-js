...
export const HSC_ADD_SLOW_RENDERER = 'HSC_ADD_SLOW_RENDERER';
export const HSC_REMOVE_SLOW_RENDERER = 'HSC_REMOVE_SLOW_RENDERER';
...
export const HSS_UPDATE_HSS_STATUS = 'HSS_UPDATE_HSS_STATUS';
