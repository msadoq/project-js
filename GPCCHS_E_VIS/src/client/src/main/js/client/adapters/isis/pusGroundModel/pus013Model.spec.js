...
describe('protobuf/isis/pusGroundModel/Pus013Model', () => {
  ...
  it('decode', () => {
    ...
    json.should.be.an('object').that.have.properties({
      ...
      noOnGoingUplinkLDTFile: { type: 'uinteger', value: fixture.noOnGoingUplinkLDTFile },
      ...
      noOnGoingUplinkLDTPacket: { type: 'uinteger', value: fixture.noOnGoingUplinkLDTPacket },
    });
