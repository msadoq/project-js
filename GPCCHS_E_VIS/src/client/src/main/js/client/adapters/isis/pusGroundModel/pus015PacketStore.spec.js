...
describe('protobuf/isis/pusGroundModel/Pus015PacketStore', () => {
  ...
  it('decode', () => {
    ...
    json.should.be.an('object').that.have.properties({
      ...
      storageType: { type: 'string', value: fixture.storageType },
    ...
    for (let i = 0; i < fixture.pus015Packet.length; i += 1) {
      json.pus015Packet[i].should.be.an('object').that.have.properties({
        ...
        serviceType: { type: 'uinteger', value: fixture.pus015Packet[i].serviceType },
        ...
        isSubsamplingRatioSet: { type: 'boolean', value: fixture.pus015Packet[i].isSubsamplingRatioSet },
      });
