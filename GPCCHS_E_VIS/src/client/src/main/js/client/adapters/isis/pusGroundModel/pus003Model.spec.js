    ...
    for (let i = 0; i < stub.pus003DiagPacket.length; i += 1) {
      expect(decoded.pus003DiagPacket[i]).toMatchObject({
        pus003Packet: {
          ...
          lastUpdateModeSid: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeSid },
          lastUpdateTimeSid: { type: 'time', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateTimeSid },
          lastUpdateModeStatus: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeStatus },
          lastUpdateTimeStatus: { type: 'time', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateTimeStatus },
          lastUpdateModeValidParamId: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeValidParamId },
          lastUpdateTimeValidParamId: { type: 'time', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateTimeValidParamId },
          lastUpdateModeValidParamMask: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeValidParamMask },
          lastUpdateTimeValidParamMask: { type: 'time', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateTimeValidParamMask },
          lastUpdateModeValidParamExpValue: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeValidParamExpValue },
          lastUpdateTimeValidParamExpValue: { type: 'time', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateTimeValidParamExpValue },
          lastUpdateModeCollectInterval: { type: 'uinteger', value: stub.pus003DiagPacket[i].pus003Packet.lastUpdateModeCollectInterval },
    ...
    for (let i = 0; i < stub.pus003HkPacket.length; i += 1) {
      expect(decoded.pus003HkPacket[i]).toMatchObject({
        ...
        pus003Packet: {
          ...
          lastUpdateModeSid: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeSid },
          lastUpdateTimeSid: { type: 'time', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateTimeSid },
          lastUpdateModeStatus: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeStatus },
          lastUpdateTimeStatus: { type: 'time', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateTimeStatus },
          lastUpdateModeValidParamId: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeValidParamId },
          lastUpdateTimeValidParamId: { type: 'time', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateTimeValidParamId },
          lastUpdateModeValidParamMask: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeValidParamMask },
          lastUpdateTimeValidParamMask: { type: 'time', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateTimeValidParamMask },
          lastUpdateModeValidParamExpValue: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeValidParamExpValue },
          lastUpdateTimeValidParamExpValue: { type: 'time', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateTimeValidParamExpValue },
          lastUpdateModeCollectInterval: { type: 'uinteger', value: stub.pus003HkPacket[i].pus003Packet.lastUpdateModeCollectInterval },
        ...
        lastUpdateModeGenMode: { type: 'uinteger', value: stub.pus003HkPacket[i].lastUpdateModeGenMode },
      });
