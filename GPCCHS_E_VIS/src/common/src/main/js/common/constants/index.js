module.exports = {
  ...
  HSC_ORCHESTRATION_CRITICAL_STEP: 400,
  HSC_RENDERER_WARNING_STEP: 250,
  HSC_RENDERER_CRITICAL_STEP: 450,
  CACHE_INVALIDATION_FREQUENCY: 18e4, // 3mn
  HSS_EVENTLOOP_WARNING_STEP: 10,
  HSS_EVENTLOOP_CRITICAL_STEP: 50,
  HSC_PUBSUB_MONITORING_FREQUENCY: 1e4, // 10s
  ...
  DC_STUB_CONGESTION_FREQUENCY: 5 * 60 * 1000, // 5mn
  // TIMELINE TYPES
