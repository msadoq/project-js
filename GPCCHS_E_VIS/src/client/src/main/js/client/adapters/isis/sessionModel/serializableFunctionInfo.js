...
const FUNCTYPE_SIZE = 1;
const FUNCTYPE_OFFSET = AUTOSTART_OFFSET + AUTOSTART_SIZE;
const INSTANCENUMBER_SIZE = 2;
const INSTANCENUMBER_OFFSET = FUNCTYPE_OFFSET + FUNCTYPE_SIZE;
...
module.exports = {
  encodeRaw: (data, buffer, offset = 0) => {
    ...
    uOCTET.encodeRaw(data.funcType, serializableFunctionInfo, FUNCTYPE_OFFSET + offset, FUNCTYPE_SIZE);
  ...
  decodeRaw: (data, buffer, offset = 0) => {
    ...
    serializableFunctionInfo.funcType = uOCTET.decodeRaw(null, bufferedData, FUNCTYPE_OFFSET + offset, FUNCTYPE_SIZE);
