  ...
  it('decode', () => {
    ...
    for (let i = 0; i < fixture.pus012ParameterMonitoringDefinition.length; i += 1) {
      json.pus012ParameterMonitoringDefinition[i].should.be.an('object').that.have.properties({
        ...
        parameterCurrentValue: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].parameterCurrentValue },
        validityParameterExpectedValue: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].validityParameterExpectedValue },
        ...
        pus012MonitoringCheckPropertiesLow: (typeof fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow === 'undefined')
          ...
          : {
            ...
            value: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesLow.value },
        ...
        pus012MonitoringCheckPropertiesHigh: (typeof fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh === 'undefined')
          ...
          : {
            ...
            value: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesHigh.value },
        ...
        pus012MonitoringCheckPropertiesExpected: (typeof fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected === 'undefined')
          ...
          : {
            ...
            value: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].pus012MonitoringCheckPropertiesExpected.value },
        ...
        protectionStatus: { type: 'string', value: fixture.pus012ParameterMonitoringDefinition[i].protectionStatus },
        isMonitoringIntervalSet: { type: 'boolean', value: fixture.pus012ParameterMonitoringDefinition[i].isMonitoringIntervalSet },
        isRepetitionNumberSet: { type: 'boolean', value: fixture.pus012ParameterMonitoringDefinition[i].isRepetitionNumberSet },
      });
