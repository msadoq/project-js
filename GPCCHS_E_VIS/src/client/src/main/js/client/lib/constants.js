module.exports = {
  ...
  DC_STUB_VALUE_ALARMTIMESTEP: 20,
  // TIMELINE TYPES
  ...
  // ground monitoring alarm
  GMA_ALARM_MODE_ALL: 'GMA_ALARM_MODE_ALL',
  GMA_ALARM_MODE_NONNOMINAL: 'GMA_ALARM_MODE_NON_NOMINAL',
  GMA_ALARM_MODE_TOACKNOWLEDGE: 'GMA_ALARM_MODE_TO_ACKNOWLEDGE',
  GMA_ALARM_ACKSTATE_ACQUITED: 'GMA_ALARM_ACKSTATE_ACQUITED',
  GMA_ALARM_ACKSTATE_REQUIREACK: 'GMA_ALARM_ACKSTATE_REQUIREACK',
  GMA_ALARM_ACKSTATE_NOACK: 'GMA_ALARM_ACKSTATE_NOACK',
  // onboard monitoring alarm
  OBA_ALARM_MODE_ALL: 'OBA_ALARM_MODE_ALL',
  OBA_ALARM_MODE_NONNOMINAL: 'OBA_ALARM_MODE_NON_NOMINAL',
  OBA_ALARM_MODE_TOACKNOWLEDGE: 'OBA_ALARM_MODE_TO_ACKNOWLEDGE',
  OBA_ALARM_ACKSTATE_ACQUITED: 'OBA_ALARM_ACKSTATE_ACQUITED',
  OBA_ALARM_ACKSTATE_REQUIREACK: 'OBA_ALARM_ACKSTATE_REQUIREACK',
  OBA_ALARM_ACKSTATE_NOACK: 'OBA_ALARM_ACKSTATE_NOACK',
};
