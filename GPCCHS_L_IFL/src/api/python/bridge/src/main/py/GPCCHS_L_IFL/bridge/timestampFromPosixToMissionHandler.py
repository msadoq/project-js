...
def perform(unitConverterLib=None, msg=None):
    ...
    # No need to read fromUnit and toUnit fields because they are not used
    ...
    resultsList = None
    try:
        resultsList = unitConverterLib.shiftTimestampFromMissionToPosixBatch(valuesToConvertList,sessionId)
        raisedErr = None
