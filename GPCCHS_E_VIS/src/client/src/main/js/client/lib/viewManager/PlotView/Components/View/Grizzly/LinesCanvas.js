...
// VERSION : 1.1.2 : DM : #3622 : 15/03/2017 : Fixed perf log in Grizzly, counting total number of
//  points differently.
...
// VERSION : 1.1.2 : DM : #5828 : 25/04/2017 : Grizzly : when y axis labels are out of range, they
//  are hidden.
// VERSION : 1.1.2 : DM : #5828 : 12/05/2017 : Small fix in Grizzly: leftMargin for LinesCanvas is
//  always accurate.
// VERSION : 1.1.2 : FA : ISIS-FT-2107 : 13/06/2017 : Prep for point labels option on PlotView.
// VERSION : 1.1.2 : DM : #6829 : 06/07/2017 : PlotView perfOutput is available, just set
//  perOutput={true} to Grizzly.
...
// VERSION : 1.1.2 : DM : #6829 : 10/07/2017 : linesCanvas prop lines[n].yAccessor is not
//  mandatory.
