...
//  with dev
// VERSION : 1.1.2 : DM : #6700 : 19/06/2017 : Remove obsolete arguments in renderer process store
//  creator
// VERSION : 1.1.2 : DM : #6700 : 26/06/2017 : Avoid "double action logging" in renderer process
//  console
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 06/07/2017 : Fix redux-logger predicate to display only
//  patched action
...
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 06/07/2017 : Do not use root reducer on mainProcess store
//  and windowProcess store
// VERSION : 1.1.2 : FA : #7145 : 04/08/2017 : Remove predicate in redux-logger, use redux-logger
//  before ipc slave dispatcher to prevent for duplicate actions
