  ...
  const { getState } = getStore({
    ...
    views: {
      view1: {
        ...
        absolutePath: '/data/work/gitRepositories/LPISIS/GPCCHS/GPCCHS_E_VIS/src/test/testAs/views/view1.json'
      },
      view2: {
        type: 'TextView',
        configuration: {},
        path: 'views/view2.json',
        absolutePath: '/data/work/gitRepositories/LPISIS/GPCCHS/GPCCHS_E_VIS/src/test/testAs/views/view2.json'
      },
      view3: {
        type: 'TextView',
        configuration: {},
        path: 'views/view3.json',
        absolutePath: '/data/work/gitRepositories/LPISIS/GPCCHS/GPCCHS_E_VIS/src/test/testAs/views/view3.json'
      },
    },
    timebars: {
      1234: {
