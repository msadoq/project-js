...
// VERSION : 2.0.0 : FA : #8045 : 06/11/2017 : PlotView can draw PropTypes.string parameters, and a defaultY
//  property can be set.
...
export default class Tooltip extends React.Component {
  static propTypes = {
    yAxesUniq: PropTypes.arrayOf(PropTypes.shape).isRequired,
    xAxesUniq: PropTypes.arrayOf(PropTypes.shape).isRequired,
