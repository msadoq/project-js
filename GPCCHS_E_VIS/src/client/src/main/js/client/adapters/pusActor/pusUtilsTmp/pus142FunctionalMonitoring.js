...
module.exports = {
  encode: data => ({
    ...
    validityParameterExpectedValue: (data.validityParameterExpectedValue !== null && typeof data.validityParameterExpectedValue !== 'undefined')
      ...
      : null,
    pus142ParameterMonitoringDefinition: _map(data.pus142ParameterMonitoringDefinition, parameterMonitoringDefinition => pus142ParameterMonitoringDefinition.encode(parameterMonitoringDefinition)),
  ...
  decode: data => ({
    ...
    validityParameterExpectedValue: (data.validityParameterExpectedValue !== null && typeof data.validityParameterExpectedValue !== 'undefined')
      ...
      : undefined,
    pus142ParameterMonitoringDefinition: _map(data.pus142ParameterMonitoringDefinition, parameterMonitoringDefinition => pus142ParameterMonitoringDefinition.decode(parameterMonitoringDefinition)),
    lastUpdateModeFMonId: (data.lastUpdateModeFMonId !== null && typeof data.lastUpdateModeFMonId !== 'undefined')
