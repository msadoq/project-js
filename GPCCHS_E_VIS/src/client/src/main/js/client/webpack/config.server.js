// ====================================================================
// HISTORY
// VERSION : 1.1.2 : DM : #5828 : 10/05/2017 : Now transpile server with babel to allow ES6 module
//  usage and store module loading in server process.
...
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 21/07/2017 : Add hiredis to webpack server config
//  externals
...
// VERSION : 2.0.0 : FA : ISIS-FT-1937 : 07/03/2018 : Change python passerelle source code folder
//  location & update packaging
// END-HISTORY
// ====================================================================
