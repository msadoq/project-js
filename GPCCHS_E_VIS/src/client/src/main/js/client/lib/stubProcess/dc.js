...
// VERSION : 1.1.2 : FA : #6798 : 21/06/2017 : Fix side effect due to stringify/parse parameters in
//  forked process
// VERSION : 1.1.2 : FA : #6993 : 21/06/2017 : Fix packaging : replace parameters.get('IS_BUNDLED')
//  by process.env.IS_BUNDLED
...
// VERSION : 1.1.2 : DM : #6700 : 06/07/2017 : Fix DC stub last and range query responses (/!\
//  ProtobufJS return a default value for optionnal enum(), you should use .hasOwnProperty() on
//  decoded payload to test the presence or not of a field)
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 18/07/2017 : Repair stubProcess dc in standalone mode (npm
//  run start:dc:stub)
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 18/07/2017 : Remove forgotten console.log . .
// VERSION : 2.0.0 : DM : #5806 : 10/10/2017 : Fix problem with headers with groundAlarm Stubs
// VERSION : 2.0.0 : DM : #5806 : 10/10/2017 : Implementation of stub for grounAlarm queries and
//  subscription.
// VERSION : 2.0.0 : DM : #5806 : 10/10/2017 : Resolve merge conflict . .
