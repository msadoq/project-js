...
module.exports = {
  encode: data => ({
    pus015PacketStore: _map(data.pus015PacketStore, packetStore => pus015PacketStore.encode(packetStore)),
  ...
  decode: data => ({
    pus015PacketStore: _map(data.pus015PacketStore, packetStore => pus015PacketStore.decode(packetStore)),
    groundDate: (data.groundDate !== null && typeof data.groundDate !== 'undefined')
