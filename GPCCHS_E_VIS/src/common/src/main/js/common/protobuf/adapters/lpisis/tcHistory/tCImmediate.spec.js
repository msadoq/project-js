...
describe('protobuf/lpisis/tcHistory/TCImmediate', () => {
  const fixture = stubData.getTCImmediate();
  let buffer;
  it('encode', () => {
    buffer = protobuf.encode('lpisis.tcHistory.TCImmediate', fixture);
    buffer.constructor.should.equal(Buffer);
  });
  it('decode', () => {
    const json = protobuf.decode('lpisis.tcHistory.TCImmediate', buffer);
