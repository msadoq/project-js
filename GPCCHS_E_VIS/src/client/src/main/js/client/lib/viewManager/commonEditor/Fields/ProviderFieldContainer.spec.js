...
import ProviderFieldContainer from './ProviderFieldContainer';
...
describe('ProviderFieldContainer :: render', () => {
  test('should render correctly with valid data', () => {
    const store = createStore(
      (state = {}) => state,
      stubState
    );
    const Decorated = reduxForm({ form: 'testsdfForm' })(ProviderFieldContainer);
