...
// VERSION : 1.1.2 : DM : #3622 : 15/02/2017 : Rename payload.focusedPageId in payload.pageId in
//  actions/pages and reducers/pages
...
// VERSION : 1.1.2 : DM : #3622 : 17/02/2017 : remove useless configuration property from payload
//  in WS_PAPGE_EDITOR_OPEN action
// VERSION : 1.1.2 : DM : #3622 : 20/02/2017 : Remove useless thunk updateTimebarId in
//  actions/pages
...
//  (page)
// VERSION : 1.1.2 : DM : #3622 : 13/03/2017 : Add readView + loadDocumentsInStore in
//  documentManager
...
// VERSION : 1.1.2 : DM : #5828 : 31/03/2017 : Add getWindowTitle selector + replace all
//  "getState().x"
...
// VERSION : 2.0.0 : FA : ISIS-FT-2267 : 23/11/2017 : creation page VIMA choix timebar
// END-HISTORY
// ====================================================================
