...
import DecommutedPacketEditor from './DecommutedPacketEditor';
...
const DecommutedPacketEditorContainer =
  connect(mapStateToProps, mapDispatchToProps)(DecommutedPacketEditor);

DecommutedPacketEditorContainer.propTypes = {
  viewId: PropTypes.string.isRequired,
  pageId: PropTypes.string.isRequired,
};

export default DecommutedPacketEditorContainer;
