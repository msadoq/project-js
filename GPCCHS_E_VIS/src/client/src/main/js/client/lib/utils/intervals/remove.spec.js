...
describe('intervals/remove', () => {
  describe('one', () => {
    ...
    it('outside lower', () => {
      ...
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[5, 10], [15, 20]]);
    });
    it('outside upper', () => {
      const knownIntervals = [[0, 10], [15, 20]];
      const intervalToExtract = [25, 30];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 10], [15, 20]]);
    });
    it('outside covering', () => {
      const knownIntervals = [[5, 10], [15, 20]];
    ...
    it('between first last', () => {
      ...
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 15], [77, 91]]);
    });
    it('first whole', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [0, 7];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[11, 14], [42, 91]]);
    });
    it('first first', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [0, 5];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[5, 7], [11, 14], [42, 91]]);
    });
    it('first middle', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [2, 5];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 2], [5, 7], [11, 14], [42, 91]]);
    });
    it('first last', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [5, 7];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 5], [11, 14], [42, 91]]);
    });
    it('middle whole', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [11, 14];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [42, 91]]);
    });
    it('middle first', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [11, 13];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [13, 14], [42, 91]]);
    });
    it('middle middle', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [12, 13];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 12], [13, 14], [42, 91]]);
    });
    it('middle last', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [12, 14];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 12], [42, 91]]);
    });
    it('last whole', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [42, 91];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 14]]);
    });
    it('last first', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [42, 49];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 14], [49, 91]]);
    });
    it('last middle', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [77, 82];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 14], [42, 77], [82, 91]]);
    });
    it('last last', () => {
      const knownIntervals = [[0, 7], [11, 14], [42, 91]];
      const intervalToExtract = [77, 91];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[0, 7], [11, 14], [42, 77]]);
    });
    it('unmerged', () => {
      const knownIntervals = [[0, 7], [3, 14], [42, 91]];
      const intervalToExtract = [0, 7];
      const intervals = remove(knownIntervals, intervalToExtract);
      expect(intervals).have.properties([[3, 14], [42, 91]]);
      ...
      expect(intervals2).have.properties([[0, 7], [42, 91]]);
    });
  });
});
