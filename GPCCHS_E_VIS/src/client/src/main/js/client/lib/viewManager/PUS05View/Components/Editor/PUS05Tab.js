      ...
      <ErrorBoundary>
        ...
        >
          ...
          <Panel
            ...
            key="pus05-sub-schedules-panel"
          >
            {
              panels['pus05-sub-schedules-panel'] &&
          ...
          <Panel
            ...
            key="pus05-commands-panel"
          >
            {
              panels['pus05-commands-panel'] &&
              <TableColumnsEditorContainer
                viewId={viewId}
                tableId={'commands'}
              />
          ...
          <Panel
            ...
            key="pus05-enabled-apids-panel"
          >
            {
              panels['pus05-enabled-apids-panel'] &&
              <TableColumnsEditorContainer
                viewId={viewId}
