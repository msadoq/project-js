...
// VERSION : 1.1.2 : DM : #3622 : 16/02/2017 : Change configuration FMD_ROOT_DIR to
//  ISIS_DOCUMENTS_ROOT
...
// VERSION : 1.1.2 : DM : #3622 : 22/02/2017 : Rename menu in menuManager and move menu.js into
//  menuManager/index.js
...
//  right-click
// VERSION : 1.1.2 : DM : #3622 : 08/03/2017 : update rtdManager tests and onOpenInspector
//  controller
...
// VERSION : 1.1.2 : DM : #5822 : 20/03/2017 : add context in dynamic view for opening parameter in
//  inspector
...
// VERSION : 1.1.2 : DM : #5828 : 30/03/2017 : Remove duplicate error message when loading default
//  workspace
...
// VERSION : 1.1.2 : DM : #5828 : 05/04/2017 : When application error is raised, display full error
//  with stack trace
// VERSION : 1.1.2 : DM : #5828 : 04/05/2017 : Implement a new "isomorphic" createStore to
//  centralize Redux configuration
...
// VERSION : 1.1.2 : FA : #5846 : 12/05/2017 : Launch vima in real time play mode: create a unique
//  action
// VERSION : 1.1.2 : DM : #5828 : 16/05/2017 : Cleanup server process fork configuration code
// VERSION : 1.1.2 : DM : #5828 : 16/05/2017 : Cleanup Redux store configuration and introduce
//  three distinct store enhancers for future store synchronisation implementation.
// VERSION : 1.1.2 : DM : #5828 : 16/05/2017 : Merge branch 'dev' into dbrugne-universal-store
// VERSION : 1.1.2 : DM : #5828 : 22/05/2017 : Move server from server/ sub-component to
//  client/lib/serverProcess
...
//  with dev
// VERSION : 1.1.2 : FA : #5838 : 16/06/2017 : Add a third parameter to childProcess to allow args
//  passing to child process
...
// VERSION : 1.1.2 : FA : #6798 : 21/06/2017 : Stringify parameters to forked process ( stub,
//  server)
// VERSION : 1.1.2 : DM : #6700 : 21/06/2017 : Merge branch 'dev' into dbrugne-lifecycle
// VERSION : 1.1.2 : DM : #6700 : 21/06/2017 : Move windows observer from main orchestration in a
//  pure store observer
...
// VERSION : 1.1.2 : DM : #6700 : 06/07/2017 : Small fix to access DEBUG value in conf, in forked
//  process
...
// VERSION : 1.1.2 : FA : ISIS-FT-1964 : 18/07/2017 : serverProcess has now a APP_ENV='server' even
//  in dev mode
