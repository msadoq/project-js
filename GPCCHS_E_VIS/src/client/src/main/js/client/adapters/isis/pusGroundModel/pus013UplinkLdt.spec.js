  ...
  test('decode', () => {
    ...
    expect(decoded).toMatchObject({
      ...
      pus013Ldt: {
        ...
        status: { type: 'uoctet', value: stub.pus013Ldt.status },
        ...
        pusElement: {
          lastUpdateMode: { type: 'uoctet', value: stub.pus013Ldt.pusElement.lastUpdateMode },
          lastUpdateTime: { type: 'time', value: stub.pus013Ldt.pusElement.lastUpdateTime },
        },
        lastUpdateModeLduId: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeLduId },
        lastUpdateTimeLduId: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeLduId },
        lastUpdateModeSize: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeSize },
        lastUpdateTimeSize: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeSize },
        lastUpdateModeStartTime: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeStartTime },
        lastUpdateTimeStartTime: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeStartTime },
        lastUpdateModeEndTime: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeEndTime },
        lastUpdateTimeEndTime: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeEndTime },
        lastUpdateModeStatus: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeStatus },
        lastUpdateTimeStatus: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeStatus },
        lastUpdateModeRemainSize: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeRemainSize },
        lastUpdateTimeRemainSize: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeRemainSize },
        lastUpdateModePercent: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModePercent },
        lastUpdateTimePercent: { type: 'time', value: stub.pus013Ldt.lastUpdateTimePercent },
        lastUpdateModeFailureCode: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeFailureCode },
        lastUpdateTimeFailureCode: { type: 'time', value: stub.pus013Ldt.lastUpdateTimeFailureCode },
        lastUpdateModeFileChecksum: { type: 'uoctet', value: stub.pus013Ldt.lastUpdateModeFileChecksum },
