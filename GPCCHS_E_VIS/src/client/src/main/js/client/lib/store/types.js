...
export const WS_WINDOW_UPDATE_DOMAINNAME = 'WS_WINDOW_UPDATE_DOMAINNAME';
export const WS_WINDOW_UPDATE_SESSIONNAME = 'WS_WINDOW_UPDATE_SESSIONNAME';
...
export const WS_EDITOR_UI_EP_PANEL = 'WS_EDITOR_UI_EP_PANEL';
